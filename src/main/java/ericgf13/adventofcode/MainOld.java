...
public class MainOld {
	...
	private static void day1() throws IOException {
		...
		String line;
		try (BufferedReader br = new BufferedReader(new FileReader(INPUT_DIRECTORY + "day01.txt"))) {
			line = br.readLine();
		}
	...
	private static void day2() throws IOException {
		...
		try (BufferedReader br = new BufferedReader(new FileReader(INPUT_DIRECTORY + "day02.txt"))) {
			String line;
	...
	private static void day4() throws IOException {
		...
		try (BufferedReader br = new BufferedReader(new FileReader(INPUT_DIRECTORY + "day04.txt"))) {
			String line;
			while ((line = br.readLine()) != null) {
	...
	private static void day5() throws IOException {
		...
		try (BufferedReader br = new BufferedReader(new FileReader(INPUT_DIRECTORY + "day05.txt"))) {
			String line;
			while ((line = br.readLine()) != null) {
	...
	private static void day6() throws IOException {
		...
		try (BufferedReader br = new BufferedReader(new FileReader(INPUT_DIRECTORY + "day06.txt"))) {
	...
	private static void day7() throws IOException {
		...
		try (BufferedReader br = new BufferedReader(new FileReader(INPUT_DIRECTORY + "day07.txt"))) {
			String line;
			while ((line = br.readLine()) != null) {
	...
	private static void day8() throws IOException {
		...
		try (BufferedReader br = new BufferedReader(new FileReader(INPUT_DIRECTORY + "day08.txt"))) {
			String line;
			while ((line = br.readLine()) != null) {
	...
	private static void day9() throws IOException {
		...
		String line;
		try (BufferedReader br = new BufferedReader(new FileReader(INPUT_DIRECTORY + "day09.txt"))) {
			line = br.readLine();
		}
